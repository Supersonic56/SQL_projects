...
PRINT 'Having fun with' + 'TSQL and SQL SERVER! '
...
INNER JOIN tbl_nutrition a6 ON a6.nutrition_id = a1.species_nutrition
INNER JOIN tbl_care a7 ON a7.care_id = a1.species_care
WHERE a1.species_name = 'brown bear';
...
(species_name, species_animalia, species_class, species_order, species_habitat, species_nutrition, species_care)
VALUES
('brown bear', 1, 102, 3, 5007, 2200, 'care_l'),
('jaguar', 1, 102, 1, 5007, 2200, 'care_4'),
('penguin', 1, 100, 1, 5003, 2200, 'care_6'),
('ghost bat', 1, 102, 1, 5007, 2204, 'care_2'),
('chicken', 1, 100, 3, 5001, 2205, 'care_0'),
...
a1.species_name, a2.animalia_type, a3.class_type, a4.order_type, a5.habitat_type, a6.nutrition_type, a7.care_type
FROM tbl_species a1
INNER JOIN tbl_animalia a2 ON a2 .anima lia_ id = al.spec ies_anima lia
INNER JOIN tbl_class a3 ON a3.class_id = al.species_class INNER JOIN tbl_order a4 ON a4.order_id = al.species_order
INNER JOIN tbl_habitat as ON a5 .habitat_id = a1.species_habitat
INNER JOIN tbl_nutrition a6 ON a6.nutrition_ id =  a1.spec ies_nutrition
INNER JOIN tbl_care a7 ON a7.care_id = a1.species_care
WHERE a1.species_name = @animalName
;
 	END
...
USE [db_zooTest2]
GO
/* Object : StoredProcedure [dbo].[getANIMAL_INFO] Script Date : 2/6/2020 4:22:54 PM */
...
a4.order_type, a5.habitat_type, a6.nurition_type, a7.care_type
FROM tbl_species a1
INNER JOIN tbl_animalia a2 ON a2 .anima lia_ id = a1.spec ies_animalia
INNER JOIN tbl_class a3 ON a3.class_id = a1.species_class 
INNER JOIN tbl_order a4 ON a4.order_id = a1.species_order
INNER JOIN tbl_habitat a5 ON a5 .habitat_id = a1.species_habitat
INNER JOIN tbl_nutrition a6 ON a6.nutrition_id = a1.species_nutrition
...
SET @totalHab = (SELECT SUM(habitat_cost) FROM tbl_hebitat);
...
CONVERT(VARCHAR(50), @totalNut) + CHAR(9) + CHAR (9) +  ' - The Total Nutrition Cost' + CHAR(13) + ‘_______’ + CHAR (13) + 
